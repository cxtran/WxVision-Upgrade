...
static const TimezoneInfo kTimezones[] = {
    ...
    {"America/Los_Angeles_GG",  "Garden Grove",    "USA",        -480, DstRule::NorthAmerica, 33.7743f,  -117.9379f},
    ...
    {"Asia/Ho_Chi_Minh_SGN",    "Saigon",          "Vietnam",     420, DstRule::None,         10.8231f,   106.6297f},
    {"Asia/Ho_Chi_Minh_HUE",    "Hue",             "Vietnam",     420, DstRule::None,         16.4637f,   107.5909f},
